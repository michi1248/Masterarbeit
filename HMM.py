...
class HMM_model:
    def __init__(
        ...
        n_iter=1000,
        path_to_subject_dat=r"D:\Lab\data\extracted\Sub2",
    ):
    ...
    def build_training_data(
        ...
        movement_names,
        path_to_subject_dat,
        window_size=int((150 / 1000) * 2048),
        overlap=int((150 / 1000) * 2048) - 150,
        split_ratio=0.8,
    ):
        segments = []
        labels = []
        ...
        self.shuffled_test_validation = np.array(
            [self.test_validation[i] for i in indices]
        )
